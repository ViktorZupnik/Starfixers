...
thrust_force = 1.0      # [N]  — cold gas thruster force magnitude
efficiency = 0.5        # 50% effective momentum transfer for torque
...
omega_threshold = 0.05  # rad/s (≈ 0.86 deg/s).  Adjust as needed.

# Simulation Time
dt = 0.1                                # [s] time step
mission_duration_sec = 192 * 60         # total available contact time (s)
...
# (We no longer need cos_theta_arr nor efficiencies in this version.)
# cos_theta_arr  = np.zeros(N_steps)
# efficiencies    = np.zeros(N_steps)
